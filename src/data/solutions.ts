...
export const solutions: Solution[] = [
  ...
  // 106
  {
    ...
    title: "Phone Microphone Not Working",
    category: "phone",
    quickFix: "Check microphone permissions and make sure the microphone opening is not blocked.",
    steps: [
      "Restart the phone.",
      "Check microphone permission for the affected app.",
      "Remove accessories that may cover the microphone.",
      "Clean the microphone opening carefully.",
      "Test the microphone with the phone's recorder."
    ]
  },
  ...
  // 107
  {
    ...
    title: "Bluetooth Not Connecting",
    category: "phone",
    quickFix: "Turn Bluetooth off and on, then pair the devices again.",
    steps: [
      "Move the devices close together.",
      "Turn Bluetooth off and back on.",
      "Forget the old paired device.",
      "Restart both devices.",
      "Pair them again."
    ]
  },
  ...
  // 118
  {
    ...
    title: "Phone Vibration Not Working",
    category: "phone",
    quickFix: "Check vibration settings and test the device.",
    steps: [
      "Open sound and vibration settings.",
      "Enable vibration options.",
      "Turn off silent modes that may disable vibration.",
      "Restart the phone.",
      "Test vibration with another function."
    ]
  },
  ...
  // 119
  {
    ...
    title: "Phone Flashlight Not Working",
    category: "phone",
    quickFix: "Close the camera and restart the phone.",
    steps: [
      "Close the camera app.",
      "Try the flashlight again.",
      "Restart the phone.",
      "Check whether the battery is extremely low.",
      "Install official system updates."
    ]
  },
  ...
  // 121
  {
    ...
    title: "Wi-Fi Signal Is Weak",
    category: "internet",
    quickFix: "Move closer to the router and reduce obstacles.",
    steps: [
      "Move the device closer to the router.",
      "Place the router in an open elevated location.",
      "Keep it away from large metal objects.",
      "Restart the router.",
      "Consider a Wi-Fi extender for large areas."
    ]
  },
  ...
  // 125
  {
    ...
    title: "Internet Works on Phone but Not TV",
    category: "internet",
    quickFix: "Reconnect the TV to Wi-Fi and restart both devices.",
    steps: [
      "Restart the TV.",
      "Restart the router.",
      "Forget the Wi-Fi network on the TV.",
      "Reconnect using the correct password.",
  ...
  // 142
  {
    ...
    title: "Door Is Difficult to Close",
    category: "home",
    quickFix: "Check alignment and visible obstructions.",
    steps: [
      "Check for objects blocking the door.",
      "Inspect the hinges visually.",
      "Check whether the door rubs against the frame.",
      "Tighten accessible hinge screws if appropriate.",
      "Call a professional if the frame is damaged."
    ]
  },
  ...
  // 143
  {
    ...
    title: "Window Is Difficult to Open",
    category: "home",
    quickFix: "Clean the track and check for visible obstructions.",
    steps: [
      "Remove dirt from the window track.",
      "Check for objects blocking movement.",
      "Clean the frame.",
      "Use suitable window-track lubricant if appropriate.",
      "Seek professional help if the frame is damaged."
    ]
  },
  ...
  // 144
  {
    ...
    title: "Water Tap Is Dripping",
    category: "home",
    quickFix: "Check the tap fitting and consider replacing the worn washer or cartridge.",
    steps: [
      "Turn the tap off fully.",
      "Observe where the water is coming from.",
      "If appropriate, shut off the local water supply before repair.",
      "Replace the worn component if you know the correct part.",
      "Call a plumber if the leak continues."
    ]
  },
  ...
  // 157
  {
    ...
    title: "Power Bank Not Charging",
    category: "electronics",
    quickFix: "Try another compatible charging cable and adapter.",
    steps: [
      "Check the cable.",
      "Check the adapter.",
      "Try another wall outlet.",
      "Allow the power bank to charge for a while.",
      "Stop using it if it becomes swollen or unusually hot."
    ],
    safety: "Do not use a swollen, leaking or damaged lithium battery."
  },
  ...
  // 166
  {
    ...
    title: "Car Battery Seems Weak",
    category: "car",
    quickFix: "Check battery terminals and have the battery tested.",
    steps: [
      "Look for visible corrosion on terminals.",
      "Check that terminals are secure.",
      "Avoid leaving lights or accessories on.",
      "Have the battery voltage and condition tested.",
      "Replace the battery if it is confirmed defective."
    ],
    safety: "Do not short battery terminals or handle damaged batteries carelessly."
  },
  ...
  // 181
  {
    ...
    title: "Rice Becomes Too Sticky",
    category: "kitchen",
    quickFix: "Use the correct water ratio and avoid excessive stirring.",
    steps: [
      "Measure rice and water consistently.",
      "Rinse rice according to the rice type.",
      "Avoid excessive water.",
      "Cook using appropriate heat.",
  ...
  // 186
  {
    ...
    title: "Milk Boils Over",
    category: "kitchen",
    quickFix: "Use moderate heat and watch the pot closely.",
    steps: [
      "Use a sufficiently large saucepan.",
      "Heat milk at moderate temperature.",
      "Stir occasionally.",
      "Stay nearby while milk is heating.",
      "Reduce heat when it starts rising."
    ]
  },
  ...
  // 192
  {
    ...
    title: "Refrigerator Is Not Cooling Properly",
    category: "kitchen",
    quickFix: "Check the temperature setting, door seal and ventilation.",
    steps: [
      "Check the refrigerator temperature setting.",
      "Make sure the door closes properly.",
      "Do not block internal air vents.",
      "Clean accessible external ventilation areas.",
      "Contact a technician if cooling remains poor."
    ]
  },
  ...
  // 194
  {
    ...
    title: "Gas Stove Flame Is Yellow",
    category: "kitchen",
    quickFix: "Stop using the burner and arrange a qualified gas-appliance inspection.",
    steps: [
      "Turn the burner off.",
      "Allow it to cool.",
      "Do not attempt to modify gas fittings.",
      "Check the appliance manual for approved cleaning instructions.",
      "Contact a qualified gas technician."
    ],
    safety: "An abnormal gas flame can indicate incomplete combustion. Do not ignore it."
  },
  ...
  // 201
  {
    ...
    title: "Clothes Have a Bad Smell After Washing",
    category: "cleaning",
    quickFix: "Do not leave wet clothes inside the washing machine.",
    steps: [
      "Remove clothes promptly after washing.",
      "Dry them completely.",
      "Clean the washing machine drum and detergent drawer.",
      "Avoid using excessive detergent.",
      "Keep the machine door slightly open when not in use if recommended."
    ]
  },
  ...
  // 202
  {
    ...
    title: "White Clothes Look Dull",
    category: "cleaning",
    quickFix: "Separate whites from colored clothing and use the correct detergent.",
    steps: [
      "Wash whites separately.",
      "Follow the garment care label.",
      "Use an appropriate detergent.",
      "Avoid overloading the machine.",
      "Dry according to the care instructions."
    ]
  },
  ...
  // 222
  {
    ...
    title: "Wall Hook Keeps Falling",
    category: "diy",
    quickFix: "Use a fixing method appropriate for the wall type and load.",
    steps: [
      "Identify whether the wall is concrete, brick, drywall or another material.",
      "Check the item's weight.",
      "Choose an appropriate wall fixing.",
      "Install according to the fixing instructions.",
      "Do not overload the hook."
    ]
  },
  ...
  // 224
  {
    ...
    title: "Cabinet Door Is Misaligned",
    category: "diy",
    quickFix: "Check and adjust the accessible hinge screws.",
    steps: [
      "Open the cabinet door.",
      "Inspect the hinges.",
      "Identify which screw controls alignment if the hinge design allows it.",
      "Make small adjustments.",
      "Close the door and test alignment."
    ]
  },
  ...
  // 236
  {
    ...
    title: "Plant Leaves Turning Yellow",
    category: "garden",
    quickFix: "Check watering, drainage and light before changing anything.",
    steps: [
      "Check whether the soil is excessively wet.",
